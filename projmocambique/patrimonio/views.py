...
from patrimonio.forms import NewUserForm, UserForm, UserProfileInfoForm
...
def special(request):
    ...
    # LOGIN_URL = '/patrimonio/user_login/'
...
def register(request):
    ...
    return render(request,'patrimonio/registration.html',
                          {'user_form':user_form,
